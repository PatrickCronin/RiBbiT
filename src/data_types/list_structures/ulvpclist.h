...
**
** If you do assign any to NULL, then be careful what ulvpclist_ functions
...
** or at least warn user at some time about what ulvpclist_ functions depend
...
** via the pointer: *ulvpclist).  Maybe this should be made consistent.
**
** CHANGELOG:
**
...
** functions in ulvpclist.c for more information), and the data existing
...
ulvpclist ulvpclist_copy_deep (ulvpclist);
...
int ulvpclist_pc (ulvpclist);
void ulvpclist_add_pc (ulvpclist, int);
void ulvpclist_sub_pc (ulvpclist, int);
